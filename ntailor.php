  ...
  if(mysqli_num_rows($result)>0)
   {
    ...
    while($row=mysqli_fetch_array($result))
    {
      ...
      echo '<td><a href="useredit.php? Product Id='.$row['pid'].'&Product Name=' .$row['pname'].'&Description='.$row['description'].'&Quantity='.$row['pquantity'].'">Edit</a> || <a href="delete.php?pid=' .$row['pid'].'">Delete</a></td>';
      echo "</tr>";
